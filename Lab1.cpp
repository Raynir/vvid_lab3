...
long float checkInput(long float g)
{
	...
	{
		cout << "Введите массу тела в граммах (целое положительное число): ";
		cin >> g;

		if (!cin)					//проверка введённых данных
		{
			cout << "Еееееееееееееееееееееееееееееееееееееееееееее, боииииииииии\n";
		...
		{
			cout << "\n";
			cout << "Вы ввели отрицательное или слишком большое число. Пожалуйста, попробуйте снова\n" << endl;
			cin.clear();
			cin.ignore(65535, '\n');
		}
